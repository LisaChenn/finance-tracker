...
// DATABASE_PATH override lets tests point at ":memory:" so they never
// touch the real per-env DB files.
const DB_PATH =
  process.env.DATABASE_PATH || path.join(DATA_DIR, `finance.${PLAID_ENV}.db`);
